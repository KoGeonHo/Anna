...
<script>
	...
	function sendMessage(form) {
		...
		form.contents.value = form.content.value.trim();
...
<<<<<<< HEAD
			...
			<c:if test="${uidx != null }">
				...
				<form onsubmit="addNeighbor(this); return false;">
						...
						내번호<input type=text name="uidx" value="${uidx}">
						이웃번호<input type="text" name="neighbor_idx" value="${vo.neighbor_idx}">
