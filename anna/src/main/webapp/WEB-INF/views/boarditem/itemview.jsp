							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="border-bottom" style="display: flex; text-align:center;">
										<span style="padding: 10px; font-size: 1.9rem; font-weight: bold;">${vo.title}</span>
									</div>
									...
									<div class="container">
										...
										<div class="col-sm-12 col-lg-12" style="    min-height: 250px; max-height:500px;}">  <!--내용 하단 -->
												...
												<div class="col-5 th"
													style="  display: table-cell; background-color: white; border: 0; font-size: 20px;border-right:solid 1px;">내용</div>
									...
									<div id="btn-area" style="margin:2px;display: flex; width: 100%; padding: 0px; flex-direction: row; justify-content: center;">
										...
										<div class="container-fluid" id="container-fluid">
											<div style="margin-top: 15px; margin-bottom: 15px;">
												<h2 style="text-align: center; font-size:1.7rem;">
										...
										<c:if test="${youritem.size() <= 0}">
													<div style="text-align: center; border-top: solid 1px; border-bottom: solid 1px;height:150px;">
														<h3 style="text-align: center; font-size:1.7rem;">${vo.nickName}님의다른상품이 없습니다 !</h3>
													</div>
													
													<h2 style="text-align: center; font-size:1.7rem">이 글과 같은 키워드의 상품</h2>
													<c:if test="${nolist==1 }">
													...
													<c:if test="${nolist == 0 }">
														<h2 style="text-align: center; font-size:1.7rem">관련 글이 없습니다.</h2>
													</c:if>
											</c:if>
											</div>
										</div>
