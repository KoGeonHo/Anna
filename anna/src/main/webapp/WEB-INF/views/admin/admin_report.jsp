                   ...
                   <form action="admin_report.do" method="post">
                      <div class = "banner_online">
                          ...
                          <div class="pop_content">
                                     ...
                                     <div  class="row border-bottom tr" id="report_table" name="model_list" style="text-align: left;">
                                        <div id="ridx">
                                    ...
                                    <div class="col-4" style="font-size: 17px; font-weight: bold;">신고유형</div>
                                    <div class="col-8"style="font-size: 17px;" id="report_type"></div>
                                 </div>
                                 <div class="row border-bottom tr">
                                     <div class="col-4" style="font-size: 17px;font-weight: bold;">신고닉네임</div>
                                     <div class="col-8"style="font-size: 17px;" id="target"></div>   
                                 </div>
                           
                                 <div  class="row border-bottom tr">
                                     <div class="col-4" style="font-size: 17px;font-weight: bold;">상세설명</div>
                                     <div class="col-8"style="font-size: 17px;" id="contents"></div>
                                 </div>
                                 <div  class="row border-bottom tr">
                                     <div class="col-4"style="font-size: 17px;font-weight: bold;">신고일</div>
                                     <div class="col-8"style="font-size: 17px;" id="date"></div>
                                 </div>
                                 <div  class="row border-bottom tr">
                                     <div class="col-4"style="font-size: 17px;font-weight: bold;">신고자</div>
                                     <div class="col-8"style="font-size: 17px;" id="repoter"></div>
                                 </div>
                                 
                                 <div  class="row border-bottom tr">
                                     <div class="col-4"style="font-size: 17px;font-weight: bold;">첨부파일</div>
                                     <div class="col-8"style="font-size: 17px; overflow: hidden" id="attach_td"></div>              
                                 </div>
                                        ...
                                        <tbody>
                                           <c:if test="${ not empty ReportList }">
                                             ...
                                             <c:if test="${i.report_type == 4}">
                                                    ...
                                                    <th>${ i.targetname }</th>
                                                 <c:if test="${ fn:length(i.contents) > 10 }">
                                                    <th>${ fn:substring(i.contents,0,9)}</th>
                                                 </c:if>
                                                 <c:if test="${ fn:length(i.contents) <= 10 }">
                                          <th>${i.contents }</th>
                                       </c:if>
                                                   ...
                                                   function check(a){
                                                    ...
                                                    success : function(data) { //리턴받은 데이터로
                                                          ...
                                                          $("#attach_td").html("<span>"+attach+"</span><img id='imgView' src='../resources/upload/"+attach+"' alt ='안되는데요' style='width:400px'>");
