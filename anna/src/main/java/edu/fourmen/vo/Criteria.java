...
public class Criteria {
	// 페이징 관련 멤버변수
		...
		// 게시글 데이터
		private List<BoardItemVO> content;
		
		// 생성자
		// size : 한 화면에 보여질 행의 수
		public Criteria(int total, int currentPage, int size, int pagingCount, List<BoardItemVO> content) {
			this.total = total;
		...
		// 데이터 VO List 리턴
		public List<BoardItemVO> getContent(){
			return this.content;
		}
